...
public class MorphingAnimation {
    ...
    public static class Params {
        ...
        public Params margin(int fromMargin, int toMargin) {
    ...
    public void start() {
        ...
        ValueAnimator marginAnimation = ValueAnimator.ofInt(mParams.fromMargin, mParams.toMargin);
        marginAnimation.addUpdateListener(valueAnimator -> {
            int val = (Integer) valueAnimator.getAnimatedValue();
            ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) mParams.button.getLayoutParams();
            layoutParams.setMargins(val, val, val, val);
        ...
        animatorSet.playTogether(strokeWidthAnimation, strokeColorAnimation, cornerAnimation, bgColorAnimation,
                heightAnimation, widthAnimation, marginAnimation);
