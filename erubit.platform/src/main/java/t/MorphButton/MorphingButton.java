...
public class MorphingButton extends androidx.appcompat.widget.AppCompatButton {
    ...
    private void morphWithAnimation(@NonNull final Params params) {
        ...
        MorphingAnimation.Params animationParams = MorphingAnimation.Params.create(this)
                ...
                .margin(mMargin, params.margin)
                .duration(params.duration)
                .listener(() -> finalizeMorphing(params));
    ...
    private void morphWithoutAnimation(@NonNull Params params) {
        ...
        if(params.width != 0 && params.height !=0) {
            ...
            layoutParams.setMargins(params.margin, params.margin, params.margin, params.margin);
    ...
    private void initView() {
        ...
        int colorDark = android.R.color.transparent;

        StateListDrawable background = new StateListDrawable();
        mDrawableNormal = createDrawable(color, cornerRadius, 0);
        mDrawablePressed = createDrawable(colorDark, cornerRadius, 0);
    ...
    public static class Params {
        ...
        public Params margin(int margin) {
            this.margin = margin;
            return this;
        }
